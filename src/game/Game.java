...
public class Game {
    /** Secret string to reveal the combination to get the goal situation (as requested by Professor D. Poitrenaud) */
     ...
     * The turn goes on until one player finds the combination, all but one player have lost the turn or if the secret command was called
     */
    public void turn() {
        setupStartOfTurn();
    ...
    /**
     * Displays a message to the user when all but one player have lost the current turn, informing that he has won the turn
    ...
    /**
     * String representation of the display at the start of each turn, with the current situation, the goal situation and the supported commands
     */
    @Override
